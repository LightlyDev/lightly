...
const Contact = ({ classicHeader, darkTheme }) => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "lightly_serviceID011223",
        "lightly_emailTemplate011",
        form.current,
        "dNOuAndWrAEgcYoxy"
      )
      .then(
            ...
            >
              <li className="social-icons-twitter">
                <Tooltip text="Twitter" placement="top">
                  <a
                    href="https://twitter.com/Lightly_LLC/"
                    target="_blank"
              ...
              <li className="social-icons-instagram">
                <Tooltip text="instagram" placement="top">
                  <a
                    href="https://www.instagram.com/lightly_llc/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <li className="social-icons-linkedin">
                <Tooltip text="LinkedIn" placement="top">
                  <a
                    href="https://www.linkedin.com/company/lightly-llc/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <li className="social-icons-github">
                <Tooltip text="Github" placement="top">
                  <a
                    href="https://github.com/LightlyDev/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
